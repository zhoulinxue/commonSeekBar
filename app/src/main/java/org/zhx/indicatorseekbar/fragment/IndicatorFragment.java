...
public class IndicatorFragment extends BaseFragment {
    ...
    protected void initView(View root) {
        ...
        CommonSeekBar seekBarWithProgress = root.findViewById(R.id.custom_indicator_by_java_code);
        seekBarWithProgress.setIndicatorTextFormat("${PROGRESS} %");

        //custom indicator text by java code
        CommonSeekBar seekBarWithTickText = root.findViewById(R.id.custom_indicator_by_java);
